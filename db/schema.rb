...
ActiveRecord::Schema.define(version: 2021_02_10_214340) do
  ...
  create_table "grades", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.integer "grade_number", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["grade_number"], name: "index_grades_on_grade_number", unique: true
  end
  ...
  create_table "students", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.string "grade_id"
    t.string "group_id"
    t.string "attendance_number", default: "", null: false
  ...
  create_table "teachers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "teacher_number", default: "", null: false
    t.boolean "grade_admin", default: false
